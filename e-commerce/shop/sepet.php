...
if(isset($_SESSION["shoppingCart"])){
   ...
   $shopping_products=$shoppingCart["ürünlistesi"];
...
<?php foreach($shopping_products as $ürün){?> 
    <tr>
        <td class="text-center" width="200px">
            <img src="admin/resimler/<?php echo $ürün->resim ; ?>" alt="" width="100px" >
        </td>
        ...
        <a href="sepet_db.php?p=incCount&ürün_id=<?php echo $ürün->id ; ?>" class="btn btn-xs btn-success"></body>
        <span class="glyphicon glyphicon-plus">+</span>
        </a>
        <input type="text" value="<?php echo $ürün->count; ?>" class="sepet-ürün-sayısı">
        <a href="sepet_db.php?p=decCount&ürün_id=<?php echo $ürün->id ; ?>" class="btn btn-xs btn-danger">
        <span class="glyphicon glyphicon-minus">-</span>
        </a>
        </td>
        <td class="text-center" width="200px"><?php echo $ürün->total_price; ?></td>
        <td class="text-center" width="120px">
        <button ürün-id="<?php echo $ürün->id; ?>" class="btn btn-danger btn-sm removeFromCartbtn">

                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="kirtasiye.php" class="nav-item nav-link">Kırtasiye</a>
                            <a href="oyuncak.html" class="nav-item nav-link active">Oyuncak</a>
                            <a href="kitap.php" class="nav-item nav-link">Kitap</a>              
                            <a href="contact.php" class="nav-item nav-link">İletişim</a>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 box-shadow">
                            ...
                            <div class="card-body">
                                ...
                                class="text-muted"><?php echo $oyuncak['fiyat']; ?>₺</small>
                            </div>
                            <div class="btn-group">
                            <button ürün-id="<?php echo $oyuncak['id']; ?>" role="button" class="button addToCartBtn">Sepete ekle</button>
                            </div>
                        </div>
                    </div>
                    <?php } ?>

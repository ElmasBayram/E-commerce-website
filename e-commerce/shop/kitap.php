                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="kirtasiye.php" class="nav-item nav-link ">Kırtasiye</a>
                            <a href="oyuncak.php" class="nav-item nav-link">Oyuncak</a>
                            <a href="kitap.php" class="nav-item nav-link active">Kitap</a>
                            <a href="contact.php" class="nav-item nav-link">İletişim</a>
                        </div>
    ...
    <div class="row px-xl-5">
        <div class="col-12">
            <nav class="breadcrumb bg-light mb-30">
                ...
                <a class="breadcrumb-item text-dark" href="oyuncak.php">Kitap</a>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 box-shadow">
                            <img class="card-img-top enlarge-image" style="height: 400px;"
                                src="./admin/kitaplar/<?php echo $kitap['resim']; ?>" alt="<?php echo $kitap['ad']; ?>">
                            <div class="card-body">
                                <h5 class="card-title"><?php echo $kitap['ad']; ?></h5>
                                <p class="card-text" style="font-size: 20px;"><?php echo $kitap['bilgi']; ?></p>
                                <div class="d-flex justify-content-between align-items-center"></div>
                                <small style="font-size: 20px;"
                                class="text-muted"><?php echo $kitap['fiyat']; ?>₺</small>
                            </div>
                            <div class="btn-group">
                            <button ürün-id="<?php echo $kitap['id']; ?>" role="button" class="button addToCartBtn">Sepete ekle</button>
                            </div>
                        </div>
                    </div>
                    <?php } ?>

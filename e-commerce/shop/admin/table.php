...
$sorgu2=$vt->prepare('SELECT *FROM iletisim1');
$sorgu2->execute();
$mesajlar=$sorgu2-> fetchAll(PDO::FETCH_OBJ);//object olarak verilerimizi çekiyoruz.*/
    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="table.php" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Kullanıcı Tablosu</a>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
               ...
               echo "<td><a href='kullanıcı.php?del_user=".$person['id']."' class='btn btn-danger'>Sil</a></td>";
              // echo "<td><a href='kullanıcı.php?del_message=".$person['id']."' class='btn btn-primary'>Güncelle</a></td>";
			   echo "</tr>";
			  } ?>
                    </thead>  
                    </table>
